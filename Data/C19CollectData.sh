...
cd /Users/paulhart/CovidProjects/Data
rm -rf COVID-19
...
/usr/local/bin/python3 /Users/paulhart/CovidProjects/Apps/C19DataCollection/C19CollectDataMain.py
echo -e  $(date) 'Creating csv data complete'
echo 

echo -e "Add files"
cd /Users/paulhart/CovidProjects
git add --all
